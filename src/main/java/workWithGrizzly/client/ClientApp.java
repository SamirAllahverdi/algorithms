package workWithGrizzly.client;
...
public class ClientApp {
    ...
    private static void mkHttpPost(String address) {
        try {
            ...
            Book b = new Book(5, "JavaScrsipt", "BigBen", Arrays.asList("z", "x", "c"));
    ...
    public static void get_example() {
        String address_get = "http://localhost:8081/shop/book";
...
//    System.out.println(response);
    ...
    public static void post_example() {
        String address_post = "http://localhost:8081/shop/book";
