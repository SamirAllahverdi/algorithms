...
//    }
    ...
    public static int makeAnagram(String first, String second) {
        ...
        first.chars().forEach(character -> {
                    final String firstWordKey = String.format("%s%s", FIRST, Character.getName(character));
        ...
        second.chars().forEach(character -> {
                    final String firstWordKey = String.format("%s%s", FIRST, Character.getName(character));
                    final String secondWordKey = String.format("%s%s", SECOND, Character.getName(character));
